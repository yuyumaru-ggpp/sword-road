...
<head>
    ...
    <title>大会のパスワード変更</title>
    <link rel="stylesheet" href="tournament-password-change-style.css">
</head>
<body>
    ...
    <div class="container">
        <h1 class="title">大会のパスワード変更</h1>
        
        <div class="form-container">
            <input type="password" class="password-input" placeholder="現在のパスワード">
            <input type="password" class="password-input" placeholder="新しいパスワード">
            <input type="password" class="password-input" placeholder="もう一度入力してください">
        </div>
