...
// セッションから保存済みデータを取得
$savedData = $_SESSION['match_results']['先鋒'] ?? null;
    ...
    <div class="main-content">
        ...
        <div class="bottom-area">
            ...
            <div class="bottom-buttons">
                <button type="button" class="bottom-button back-button" onclick="location.href='team-order-registration.php'">戻る</button>
