...
@media (max-height:600px) {
    ...
    .score-dropdown { width:28px; height:28px; font-size:0.9rem; }
    ...
    <div class="content-wrapper">
        ...
        <div class="bottom-area">
            ...
            <div class="bottom-buttons">
                ...
                <button class="bottom-button submit-button" id="submitButton" style="display:none;">送信・保存</button>
            </div>
        </div>
    </div>
</div>
...
function saveLocal() {
    ...
    data.positions[key].special = dt==='一本勝'?'ippon':dt==='延長'?'extend':dt==='引分け'?'draw':'none';
}
