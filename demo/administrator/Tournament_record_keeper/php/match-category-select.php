...
<head>
    ...
    <link rel="stylesheet" href="../css/match-category-style.css">
</head>
<body>
    <div class="breadcrumb">
        <a href="tournament-detail.php" class="breadcrumb-link">メニュー></a>
        <a href="match-edit.php" class="breadcrumb-link">試合内容変更></a>
    </div>
    ...
    <div class="container">
        ...
        <div class="category-grid">
            <button class="category-button" onclick="location.href='match-list.php?category=elementary-boys'">
                小学生男子部門
            </button>
