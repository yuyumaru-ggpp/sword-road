...
<head>
    ...
    <title>試合選択</title>
    <link rel="stylesheet" href="../css/match-select-style.css">
</head>
<body>
    <div class="breadcrumb">
        <a href="tournament-detail.php" class="breadcrumb-link">メニュー></a>
        <a href="match-category-select.html" class="breadcrumb-link">試合内容変更></a>
    </div>
    ...
    <div class="container">
        ...
        <div class="match-grid">
            <button class="match-button" onclick="location.href='team-match-detail.php?match=5'">第五試合</button>
