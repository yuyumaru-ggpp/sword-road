...
<head>
    ...
    <title>大会登録</title>
    <link rel="stylesheet" href="../css/tournament-category-select-style.css">
    <style>
...
<body>
        ...
        <div class="category-section">
            ...
            <div class="categories-grid">
                <div class="category-column">
                    <h3 class="category-title">個人戦</h3>
                ...
                <div class="category-column">
                    <h3 class="category-title">団体戦</h3>
                    <div class="checkbox-list">
                        <label class="checkbox-item">
                            <input type="checkbox">
                            <span>小学生団体(5人制)</span>
    ...
    <script>
        ...
        document.getElementById('registerButton').addEventListener('click', function() {
            ...
            console.log('選択された部門:', categories);
            
            if (categories.length === 0) {
                alert('部門を1つ以上選択してください');
                return;
            }
