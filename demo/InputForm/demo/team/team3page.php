...
<head>
    ...
    <title>ページ3</title>
    <link rel="stylesheet" href="./team3page_3.css">
</head>
<body>
    <div class="header">
        ...
        <div class="header-right">
            <button class="btn-white">大将</button>
            <a href="team4page.php" class="btn-next">次へ</a>
            <a href="team2page.php" class="btn-back">戻る</a>
        </div>
    </div>
