...
<head>
    ...
    <link rel="stylesheet" href="../css/edit/tournament-unlock-style.css">
</head>
<body>
    <div class="breadcrumb">
        <a href="master2.html" class="breadcrumb-link">メニュー></a>
        <a href="tournament-unlock.html" class="breadcrumb-link">大会ロック解除></a>
    </div>
    ...
    <div class="container">
        ...
        <div class="back-button-container">
            <button class="back-button" onclick="location.href='master2.html'">戻る</button>
        </div>
    </div>
</body>
</html>